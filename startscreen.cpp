    ...
    ui(new Ui::StartScreen)
{
    ...
    connect(ui -> loginWidget, &LoginForm::rejected, this, &StartScreen::onRejectedRequest);
    ...
    connect(ui -> registerWidget, &RegistrationForm::rejected, this, &StartScreen::onRejectedRequest);
...
void StartScreen::onRejectedRequest()
{
    reject();
}
